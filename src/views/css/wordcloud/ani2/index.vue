<template>
  <div class="flex flex-col w-full h-full">
    <h1>echart graph实现</h1>
    <div class="flex-1 black">
      <div id="echart-cloud" class="w-full h-full"></div>
    </div>
  </div>
</template>
<script lang="ts" setup>
  ...
  function greneteCloud() {
    var chartDom = document.getElementById('echart-cloud');
    if (!chartDom) return;
