<template>
  <div class="p-4">
    <BasicTable @register="registerTable">
      ...
      <template #imgs="{ text }">
        <TableImg :size="60" :imgList="text" /> </template>
      ...
      <template #calculation="{ record }">
        <Button>编辑</Button>
      </template>
      <template #bodyCell="{ column}">
        <template v-if="column.dataIndex === 'calculation'">
...
export default defineComponent({
  components: { BasicTable, TableImg, Tag, Avatar, Button },
  setup() {
